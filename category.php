<?php get_header(); ?>
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="load-more col-xs-12 btn" data-category="<?php echo $query_by_cats; ?>" data-grid="3" data-post-type="post" data-posts-per-page="<?php echo $postsPerPage ?>">No more posts avaliable</div>

        <?php else: ?>
        <div class="load-more col-xs-12 btn" data-category="<?php echo $query_by_cats; ?>" data-grid="3" data-post-type="post" data-posts-per-page="<?php echo $postsPerPage ?>">Load more posts</div>
        <?php endif;
        wp_reset_postdata(); ?>
    </div>
