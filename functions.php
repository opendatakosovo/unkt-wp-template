...
function my_bootstrap_theme_scripts(){
  ...
  //  wp_enqueue_script( 'jquery' );
	...
	wp_register_style( 'bootstrap-fonts', get_template_directory_uri() . '/bootstrap/fonts/glyphicons-halflings-regular.woff', array(), '3.0.1', 'all' );

	wp_enqueue_script( 'bootstrap-js' );
	// wp_enqueue_script('jquery-js');
	// wp_enqueue_style( 'bootstrap-css' );
	wp_enqueue_style( 'bootstrap-fonts' );

}
add_filter( 'wp_enqueue_scripts', 'my_bootstrap_theme_scripts' );
