...
<div class="row">
 <div class="tabs-menu" id="tabs">
   ...
   <div id="latest">
     <div class="row">
      ...
      <?php if ( $loop->found_posts < $postsPerPage ) : ?>
         <div class="load-more-home disable-button-no-more-posts-available col-xs-12 btn" data-grid="3" data-page-name="home" data-posts-per-page="<?php echo $postsPerPage ?>">No more posts available</div>
   ...
   <div id="tenders">
     <div class="row">
         <div id="tenders-container" class="article-container filterize">
